...
# [[Dead Code]] Creating a logging pattern into log4j is better than printing info
...
#[[Duplicated Code]] except the csv paarameter the same code is used bellow for reading the yellow data 
#[[Exposed Internals]] Need to hide implementation details
...
#[[Duplicated Code]] same code used bellow in yellowTaxiTripDataDF block
#[[Exposed Internals]] Need to hide implementation details
greenTaxiTripDataDF = (
                       greenTaxiTripDataDF
                       #[[Duplicated Code]]
...
#[[Duplicated Code]] same code used bellow in yellowTaxiTripDataDF transformation
#[[Exposed Internals]] Need to hide implementation details
...
#[[Duplicated Code]] except the csv paarameter the same code is used above for reading the green data 
#[[Exposed Internals]] Need to hide implementation details
...
#[[Duplicated Code]] same code used above in greenTaxiTripDataDF
#[[Exposed Internals]] Need to hide implementation details
...
#[[Duplicated Code]] Same code used above in greenTaxiTripDataDF transformation
#[[Exposed Internals]] Need to hide implementation details
...
# [[Dead Code]] Creating a logging pattern into log4j is better than printing info
print("Union on Yellow/Green Taxi data")    
...
# [[Magic Command]] using sql in python notebook 
